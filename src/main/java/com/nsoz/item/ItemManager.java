...
public class ItemManager {
    ...
    public int randomItemGloryTask(Char _char) {
        ...
        for (ItemTemplate template : listItemGloryTask) {
            if ((template.isTypeClothe() && template.gender == _char.gender) || template.isTypeAdorn() || template.isTypeWeapon()) {
    ...
    public void loadItem() {
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement("SELECT * FROM `item`;", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    public void loadItemOption() {
        try {
            ...
            PreparedStatement stmt =
                    conn.prepareStatement("SELECT * FROM `item_option`;", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            ResultSet resultSet = stmt.executeQuery();
            resultSet.last();
