...
public class ItemFactory {
    ...
    public Item newItem9X(int id, boolean isMaxOption, byte... itemSys) {
        Item itm = newItem(id);
        itm.randomOptionItem9x(isMaxOption, itemSys);
        return itm;
    }
    ...
    public Item newItemWithCustomOption(int id, List<ItemOption> options, long expire) {
        Item item = new Item(id, options);
        long now = System.currentTimeMillis();
        item.setCreatedAt(now);
        item.setUpdatedAt(now);
        item.setNew(true);
    ...
    public Item newGem(int id, boolean max) {
        ...
        if (max) {
            ...
            item.options.add(new ItemOption(123, 0));
        } else {
            item.options.clear();
            if (item.id == 652) {
                item.options.add(new ItemOption(106, 0));
                item.options.add(new ItemOption(102, NinjaUtils.nextInt(1, 500)));
                item.options.add(new ItemOption(115, -NinjaUtils.nextInt(1, 10)));
                item.options.add(new ItemOption(107, 0));
                item.options.add(new ItemOption(126, NinjaUtils.nextInt(1, 5)));
                item.options.add(new ItemOption(105, -NinjaUtils.nextInt(1, 500)));
                item.options.add(new ItemOption(108, 0));
                item.options.add(new ItemOption(114, NinjaUtils.nextInt(1, 5)));
                item.options.add(new ItemOption(118, -NinjaUtils.nextInt(1, 10)));
            } else if (item.id == 653) {
                item.options.add(new ItemOption(106, 0));
                item.options.add(new ItemOption(73, NinjaUtils.nextInt(1, 100)));
                item.options.add(new ItemOption(114, -NinjaUtils.nextInt(1, 5)));
                item.options.add(new ItemOption(107, 0));
                item.options.add(new ItemOption(124, NinjaUtils.nextInt(1, 10)));
                item.options.add(new ItemOption(114, -NinjaUtils.nextInt(1, 100)));
                item.options.add(new ItemOption(108, 0));
                item.options.add(new ItemOption(115, NinjaUtils.nextInt(1, 10)));
                item.options.add(new ItemOption(119, -NinjaUtils.nextInt(1, 10)));
            } else if (item.id == 654) {
                item.options.add(new ItemOption(106, 0));
                item.options.add(new ItemOption(103, NinjaUtils.nextInt(1, 200)));
                item.options.add(new ItemOption(125, -NinjaUtils.nextInt(1, 50)));
                item.options.add(new ItemOption(107, 0));
                item.options.add(new ItemOption(121, NinjaUtils.nextInt(1, 5)));
                item.options.add(new ItemOption(120, -NinjaUtils.nextInt(1, 10)));
                item.options.add(new ItemOption(108, 0));
                item.options.add(new ItemOption(116, NinjaUtils.nextInt(1, 10)));
                item.options.add(new ItemOption(126, -NinjaUtils.nextInt(1, 5)));
            } else if (item.id == 655) {
                item.options.add(new ItemOption(106, 0));
                item.options.add(new ItemOption(105, NinjaUtils.nextInt(1, 500)));
                ...
                item.options.add(new ItemOption(107, 0));
                item.options.add(new ItemOption(125, NinjaUtils.nextInt(1, 50)));
                item.options.add(new ItemOption(117, -NinjaUtils.nextInt(1, 50)));
                item.options.add(new ItemOption(108, 0));
                item.options.add(new ItemOption(117, NinjaUtils.nextInt(1, 50)));
                item.options.add(new ItemOption(124, -NinjaUtils.nextInt(1, 10)));
            }
