...
public class StoreManager {
    ...
    public List<ItemStore> getListEquipmentWithLevelRange(int start, int end) {
        ...
        int[] types = {TYPE_WEAPON, TYPE_NECKLACE, TYPE_RING, TYPE_PEARL, TYPE_SPELL, TYPE_MEN_HAT, TYPE_MEN_SHIRT, TYPE_MEN_GLOVES, TYPE_MEN_PANT,
                TYPE_MEN_SHOES, TYPE_WOMEN_HAT, TYPE_WOMEN_SHIRT, TYPE_WOMEN_GLOVES, TYPE_WOMEN_PANT, TYPE_WOMEN_SHOES};
        for (int type : types) {
