...
public class ItemStore {
    ...
    @Builder
    public ItemStore(int id, int itemID, byte sys, int coin, int yen, int gold, boolean isLock, long expire, List<ItemOption> options) {
        this.id = id;
        this.itemID = itemID;
        this.sys = sys;
        this.coin = coin;
    ...
    public void setMinOptions() {
        ...
        for (ItemOption o : maxOptions) {
            ...
            int newParam;
            if (optionID == 0 || optionID == 1 || optionID == 21 || optionID == 22 || optionID == 23 || optionID == 24 || optionID == 25
                    || optionID == 26) {
                newParam = optionParam - 49;
            } else if (optionID == 6 || optionID == 7 || optionID == 8 || optionID == 9 || optionID == 19) {
                newParam = optionParam - 9;
            } else if (optionID == 2 || optionID == 3 || optionID == 4 || optionID == 5 || optionID == 10 || optionID == 11 || optionID == 12
                    || optionID == 13 || optionID == 14 || optionID == 15 || optionID == 17 || optionID == 18) {
