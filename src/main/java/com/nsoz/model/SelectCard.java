...
public class SelectCard extends AbsSelectCard {
    ...
    public static final long EXPIRE_3_DAY = 259200000;
    public static final long EXPIRE_7_DAY = 604800000;

    @Override
    protected void init() {
        add(Card.builder().id(ItemName.TUI_VAI_CAP_3).rate(1).build());
        add(Card.builder().id(ItemName.TUI_VAI_CAP_4).rate(1).build());
        ...
        add(Card.builder().id(ItemName.MAT_NA_SUPER_BROLY).rate(0.5).expire(EXPIRE_7_DAY).build());
        ...
        add(Card.builder().id(ItemName.HUYET_SAC_HUNG_LANG).rate(0.75).expire(EXPIRE_3_DAY).build());
        ...
        add(Card.builder().id(ItemName.DA_CAP_7).rate(5).build());
        add(Card.builder().id(ItemName.DA_CAP_8).rate(5).build());
        add(Card.builder().id(ItemName.DA_CAP_9).rate(4).build());
        add(Card.builder().id(ItemName.DA_CAP_10).rate(3).build());
        add(Card.builder().id(ItemName.DA_CAP_11).rate(2).build());
        add(Card.builder().id(ItemName.DA_CAP_12).rate(1).build());
        add(Card.builder().id(ItemName.GA_TAY).rate(10).build());
        add(Card.builder().id(ItemName.TOM_HUM).rate(10).build());
        add(Card.builder().id(ItemName.HAGGIS).rate(10).build());
        add(Card.builder().id(ItemName.YEN).rate(8).quantity(10000).build());
        add(Card.builder().id(ItemName.YEN).rate(8).quantity(20000).build());
        add(Card.builder().id(ItemName.YEN).rate(8).quantity(30000).build());
        add(Card.builder().id(ItemName.YEN).rate(8).quantity(50000).build());
        add(Card.builder().id(ItemName.YEN).rate(8).quantity(100000).build());
        add(Card.builder().id(ItemName.YEN).rate(6).quantity(200000).build());
        add(Card.builder().id(ItemName.YEN).rate(4).quantity(500000).build());
        add(Card.builder().id(ItemName.YEN).rate(3).quantity(1000000).build());
        add(Card.builder().id(ItemName.YEN).rate(3).quantity(5000000).build());
        ...
        add(Card.builder().id(ItemName.SACH_VO_CONG_PAWARAIKOU).rate(1.75).build());
        add(Card.builder().id(ItemName.SACH_VO_CONG_TOTOGAI).rate(1.75).build());
        add(Card.builder().id(ItemName.SACH_VO_CONG_KITSUKEMAGUMA).rate(1.75).build());
        add(Card.builder().id(ItemName.SACH_VO_CONG_TOTAAIGO).rate(1.75).build());
        add(Card.builder().id(ItemName.SACH_VO_CONG_IKENNOTTO).rate(1.75).build());
        add(Card.builder().id(ItemName.SACH_VO_CONG_OOENJO).rate(1.75).build());
        ...
        add(Card.builder().id(ItemName.BAO_HIEM_TRUNG_CAP).rate(2.5).build());
        add(Card.builder().id(ItemName.SASHIMI_CAO_CAP).rate(5).build());
        add(Card.builder().id(ItemName.GA_QUAY_CAO_CAP).rate(5).build());
        add(Card.builder().id(ItemName.HOAN_COT_CHI_CHU_SO_CAP).rate(7.5).build());
        add(Card.builder().id(ItemName.HOAN_COT_CHI_CHU_TRUNG_CAP).rate(7.5).build());
    }
    ...
    protected Card reward(@NotNull Char p, Card card) {
        ...
        if (itemID == ItemName.YEN) {
            ...
            if (NinjaUtils.nextInt(100) <= 5) {
                ...
                List<ItemStore> list = StoreManager.getInstance().getListEquipmentWithLevelRange(itemLevel - 9, itemLevel + 9);
                if (!list.isEmpty()) {
    ...
    @Override
    protected void selectCardSuccessful(@NotNull Char p) {
        int index = p.getIndexItemByIdInBag(ItemName.PHIEU_MAY_MAN);
