...
public class RandomItem {
    ...
    public static void init() {
        ...
        /*
         * SUMMER.add(3, ItemName.KEM_OC_QUE); SUMMER.add(5, ItemName.KEM_SUA); SUMMER.add(2,
         * ItemName.KEM_DAU); SUMMER.add(2, ItemName.KEM_CHOCOLATE);
         */
        ...
        LANG_BAO.add(0.5, ItemName.XICH_NHAN_NGAN_LANG);
