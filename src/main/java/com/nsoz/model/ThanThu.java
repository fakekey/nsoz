...
public class ThanThu {
    ...
    public void hatchedEgg() {
        ...
        stars = 1;
        options.clear();
        addOption(new ItemOption(ST_QUAI_ID, 150 * level * stars));
        addOption(new ItemOption(ST_NGUOI_ID, 30 * level * stars));
    }
        ...
        if (this.level <= 100) {
            ...
            for (ItemOption o : options) {
                ...
                if (o.optionTemplate.id == ST_QUAI_ID) {
                    add = 150 * this.level * this.stars;
                }
                if (o.optionTemplate.id == ST_NGUOI_ID) {
                    add = 30 * this.level * this.stars;
                }
                o.param = add;
                setAttribute(o);
            }
