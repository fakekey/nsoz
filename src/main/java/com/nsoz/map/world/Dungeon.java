...
public class Dungeon extends World {
    ...
    public static final int[][] MAP_DUNGEON = {{91, 92, 93}, {94, 95, 96, 97}, {105, -1, 109}, {114, 115, 116}, {125, 126, 127, 128}, {-2}};
    public static final int[] MAP_DUNGEON_5X = {106, 107, 108};
    public static final int[] MAP_DUNGEON_9X = {157, 158, 159};
    public static final int[][] INFO =
            {{91, 35, 264, 0, 35}, {94, 35, 408, 1, 45}, {105, 35, 360, 2, 55}, {114, 35, 576, 3, 65}, {125, 35, 552, 4, 75}, {157, 60, 264, 5, 95}};
                ...
                if (mobs.isEmpty()) {
                    if ((index == MAP_DUNGEON[level].length - 1) || (level == 2 && index == 4)) {
                        if (level == 4 && !bossAppeared) {
                            ...
                            Mob mob = new Mob(size, (short) 138, 120000000, (short) 75, (short) 756, (short) 672, false, true, zone);
                            size++;
                            Mob mob2 = new Mob(size, (short) 138, 120000000, (short) 75, (short) 708, (short) 672, false, true, zone);
                            zone.addMob(mob);
                            zone.addMob(mob2);
                            bossAppeared = true;
                        } else {
                    ...
                    if (zone.tilemap.id == 114 || zone.tilemap.id == 115) {
                        if (mobs.get(0).hp > 100) {
                            ...
                            for (Mob mob : mobs) {
                                if (mob.template.id == MobName.TRUNG_TAM_SAC || mob.template.id == MobName.LAM_THACH_THAO) {
                                    mobLive = true;
                                    break;
                                }
                            }
