...
public class TileMap {
    ...
    public boolean isNotAllowPkPoint() {
        return this.id == 138 || this.id == 137 || this.id == 136 || this.id == 135 || this.id == 134 || this.id == 162 || this.id == 163
                || this.id == 164 || this.id == 165;
    }
    ...
    public boolean isLangTruyenThuyet() {
        return id == MapName.LANG_SHIIBA || id == MapName.HANG_KISO || id == MapName.DAO_BAY_NOKKI || id == MapName.DEN_HASHI;
    }

    public boolean isLangCo() {
        return id == MapName.LANG_FEARRI || id == MapName.NUI_DORAGON || id == MapName.RUNG_MAJO || id == MapName.VUC_YUNIKOON
                || id == MapName.DONG_KINGU;
    }
    ...
    public boolean isNhaThiDau() {
        return id == MapName.NHA_THI_DAU_HARUNA || id == MapName.NHA_THI_DAU_HIROSAKI || id == MapName.NHA_THI_DAU_OOKAZA;
    }
    ...
    public boolean isNotTeleport() {
        return isLoiDai() || isDauTruong() || isChienTruong() || isDungeo() || isDungeoClan() || isNhaThiDau() || isThatThuAi() || isFujukaSanctuary()
                || isCandyBattlefield();
    }
    ...
    public boolean isNotSave() {
        return isDungeo() || isDungeoClan() || isChienTruong() || isDauTruong() || isLoiDai() || isFujukaSanctuary() || isNhaThiDau() || isThatThuAi()
                || id == MapName.KHU_BAO_DANH || id == MapName.HANG_INOSHISHI || id == MapName.DIA_DAO_CHIKATOYA || isDauTruong()
                || isCandyBattlefield() || id == MapName.HANG_NYMOZ;
    }
    ...
    public short collisionY(short x, short y) {
        ...
        y = (short) (y / 24 * 24);
        while (y < this.pxh) {
            if (tileTypeAt(x, y, TileMap.T_TOP) || tileTypeAt(x, y, TileMap.T_BRIDGE) || tileTypeAt(x, y, TileMap.T_WATERFLOW)) {
                return y;
            }
            y += 24;
        }
    ...
    public boolean isInWaypoint(int cx, int cy) {
        ...
        while ((int) b < num) {
            ...
            if (cx >= (int) waypoint.minX && cx <= (int) waypoint.maxX && cy >= (int) waypoint.minY && cy <= (int) waypoint.maxY) {
                return true;
            }
            b += 1;
        }
    ...
    public void loadMap() {
        ...
        try {
            ...
            for (int i = 0; i < length; ++i) {
                ...
                if (tileId == 4) {
                    if (maps[i] == 1 || maps[i] == 2 || maps[i] == 3 || maps[i] == 4 || maps[i] == 5 || maps[i] == 6 || maps[i] == 9 || maps[i] == 10
                            || maps[i] == 79 || maps[i] == 80 || maps[i] == 13 || maps[i] == 14 || maps[i] == 43 || maps[i] == 44 || maps[i] == 45
                            || maps[i] == 50) {
                        types[i] |= T_TOP;
                    }
                ...
                if (tileId == 1) {
                    if (maps[i] == 1 || maps[i] == 2 || maps[i] == 3 || maps[i] == 4 || maps[i] == 5 || maps[i] == 6 || maps[i] == 7 || maps[i] == 36
                            || maps[i] == 37 || maps[i] == 54 || maps[i] == 91 || maps[i] == 92 || maps[i] == 93 || maps[i] == 94 || maps[i] == 73
                            || maps[i] == 74 || maps[i] == 97 || maps[i] == 98 || maps[i] == 116 || maps[i] == 117 || maps[i] == 118 || maps[i] == 120
                            || maps[i] == 61) {
                        types[i] |= T_TOP;
                    }
                    if (maps[i] == 2 || maps[i] == 3 || maps[i] == 4 || maps[i] == 5 || maps[i] == 6 || maps[i] == 20 || maps[i] == 21
                            || maps[i] == 22 || maps[i] == 23 || maps[i] == 36 || maps[i] == 37 || maps[i] == 38 || maps[i] == 39 || maps[i] == 61) {
                        types[i] |= T_SOLIDGROUND;
                    }
                    if (maps[i] == 8 || maps[i] == 9 || maps[i] == 10 || maps[i] == 12 || maps[i] == 13 || maps[i] == 14 || maps[i] == 30) {
                        types[i] |= T_TREE;
                    }
                    if (maps[i] == 17) {
                        types[i] |= T_WATERFALL;
                ...
                if (tileId == 2) {
                    if (maps[i] == 1 || maps[i] == 2 || maps[i] == 3 || maps[i] == 4 || maps[i] == 5 || maps[i] == 6 || maps[i] == 7 || maps[i] == 36
                            || maps[i] == 37 || maps[i] == 54 || maps[i] == 61 || maps[i] == 73 || maps[i] == 76 || maps[i] == 77 || maps[i] == 78
                            || maps[i] == 79 || maps[i] == 82 || maps[i] == 83 || maps[i] == 98 || maps[i] == 99 || maps[i] == 100 || maps[i] == 102
                            || maps[i] == 103 || maps[i] == 108 || maps[i] == 109 || maps[i] == 110 || maps[i] == 112 || maps[i] == 113
                            || maps[i] == 116 || maps[i] == 117 || maps[i] == 125 || maps[i] == 126 || maps[i] == 127 || maps[i] == 129
                            || maps[i] == 130) {
                        types[i] |= T_TOP;

                    }
                    if (maps[i] == 1 || maps[i] == 3 || maps[i] == 4 || maps[i] == 5 || maps[i] == 6 || maps[i] == 20 || maps[i] == 21
                            || maps[i] == 22 || maps[i] == 23 || maps[i] == 36 || maps[i] == 37 || maps[i] == 38 || maps[i] == 39 || maps[i] == 55
                            || maps[i] == 109 || maps[i] == 111 || maps[i] == 112 || maps[i] == 113 || maps[i] == 114 || maps[i] == 115
                            || maps[i] == 116 || maps[i] == 127 || maps[i] == 129 || maps[i] == 130) {
                        types[i] |= T_SOLIDGROUND;
                    }
                    if (maps[i] == 8 || maps[i] == 9 || maps[i] == 10 || maps[i] == 12 || maps[i] == 13 || maps[i] == 14 || maps[i] == 30
                            || maps[i] == 135) {
                    ...
                    if (maps[i] == 61 || maps[i] == 37 || maps[i] == 38 || maps[i] == 127 || maps[i] == 130 || maps[i] == 131) {
                        types[i] |= T_LEFT;
                    }
                    if (maps[i] == 61 || maps[i] == 36 || maps[i] == 39 || maps[i] == 127 || maps[i] == 129 || maps[i] == 132) {
                        types[i] |= T_RIGHT;
                    }
                    if (maps[i] == 19) {
                        types[i] |= T_WATERFLOW;
                ...
                if (tileId == 3) {
                    if (maps[i] == 1 || maps[i] == 2 || maps[i] == 3 || maps[i] == 4 || maps[i] == 5 || maps[i] == 6 || maps[i] == 7 || maps[i] == 11
                            || maps[i] == 14 || maps[i] == 17 || maps[i] == 43 || maps[i] == 51 || maps[i] == 63 || maps[i] == 65 || maps[i] == 67
                            || maps[i] == 68 || maps[i] == 71 || maps[i] == 72 || maps[i] == 83 || maps[i] == 84 || maps[i] == 85 || maps[i] == 87
                            || maps[i] == 91 || maps[i] == 94 || maps[i] == 97 || maps[i] == 98 || maps[i] == 106 || maps[i] == 107 || maps[i] == 111
                            || maps[i] == 113 || maps[i] == 117 || maps[i] == 118 || maps[i] == 119 || maps[i] == 125 || maps[i] == 126
                            || maps[i] == 129 || maps[i] == 130 || maps[i] == 131 || maps[i] == 133 || maps[i] == 136 || maps[i] == 138
                            || maps[i] == 139 || maps[i] == 142) {
                        types[i] |= T_TOP;
                    }
                    if (maps[i] == 124 || maps[i] == 116 || maps[i] == 123 || maps[i] == 44 || maps[i] == 12 || maps[i] == 15 || maps[i] == 16
                            || maps[i] == 45 || maps[i] == 10 || maps[i] == 9) {
                        types[i] |= T_SOLIDGROUND;
                    }
                    if (maps[i] == 23) {
                        types[i] |= T_WATERFALL;
                    ...
                    if (maps[i] == 6 || maps[i] == 15 || maps[i] == 51 || maps[i] == 95 || maps[i] == 97 || maps[i] == 106 || maps[i] == 111
                            || maps[i] == 123 || maps[i] == 125 || maps[i] == 138 || maps[i] == 140) {
                        types[i] |= T_LEFT;
                    }
                    if (maps[i] == 7 || maps[i] == 16 || maps[i] == 51 || maps[i] == 96 || maps[i] == 98 || maps[i] == 107 || maps[i] == 111
                            || maps[i] == 124 || maps[i] == 126 || maps[i] == 139 || maps[i] == 141) {
                        types[i] |= T_RIGHT;
                    }
                    if (maps[i] == 25) {
                        types[i] |= T_WATERFLOW;
                    ...
                    if (maps[i] == 33 || maps[i] == 103 || maps[i] == 104 || maps[i] == 105 || maps[i] == 26 || maps[i] == 33) {
                        types[i] |= T_OUTSIDE;
                    }
