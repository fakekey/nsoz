...
public class TrungThu extends Event {
    ...
    public void banhThapCam(Char p, int amount) {
        int[][] itemRequires =
                new int[][] {{ItemName.BOT_MI, 10}, {ItemName.TRUNG, 5}, {ItemName.HAT_SEN, 5}, {ItemName.DUONG, 5}, {ItemName.MUT, 5}};
    ...
    public void hopBanhThuong(Char p, int amount) {
        int[][] itemRequires = new int[][] {{ItemName.GIAY_GOI_THUONG, 1}, {ItemName.BANH_THAP_CAM, 1}, {ItemName.BANH_DEO, 1},
                {ItemName.BANH_DAU_XANH, 1}, {ItemName.BANH_PIA, 1}};
    ...
    public void hopBanhThuongHang(Char p, int amount) {
        int[][] itemRequires = new int[][] {{ItemName.GIAY_GOI_CAO_CAP, 1}, {ItemName.BANH_THAP_CAM, 1}, {ItemName.BANH_DEO, 1},
                {ItemName.BANH_DAU_XANH, 1}, {ItemName.BANH_PIA, 1}};
    ...
    /*
     * @Override public EventPoint createEventPoint() { return null; }
     */
